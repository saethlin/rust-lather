...
fn planck(wavelength: f64, temperature: f64) -> f64 {
    ...
    let k_b = 1.380e-23;
    2.0 * h * c.powi(2) * 1.0 / (wavelength.powi(5) * (exp_m1((h * c) / (wavelength * k_b * temperature))))
}
...
mod tests {
    ...
    #[test]
    fn test_accuracy() {
        assert!(is_close(planck_integral(5778.0, 4000e-10, 7000e-10), 7359875.725388271));
    }

    #[test]
     fn test_order_proof() {
        assert_eq!(planck_integral(5778.0, 4000e-10, 7000e-10), planck_integral(5778.0, 7000e-10, 4000e-10));
     }
}
